...
-- 3. Используя файл employees.txt заполнить таблицу
...
-- 4. Изменить телефонный номер сотрудника с id 102 на '515.123.4555'
update employees
set phone = '515.123.4555'
where employee_id = 102;

-- 5. Удалить сотрудника с именем Alexander и с фамилией Hunold из таблицы 
